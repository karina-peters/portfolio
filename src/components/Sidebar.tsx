...
export function Sidebar({ activeSection }: { activeSection: string }) {
  return (
    <header className="flex flex-col justify-between h-lvh sticky top-0 py-18 pl-16">
      <div className="">
        <h1>Karina Peters</h1>
        <span className="font-mono font-medium text-xl text-neutral-70">Software Engineer</span>
      </div>
      ...
      <div className="flex flex-row gap-8">
        <a href="https://github.com/karina-peters" target="_blank">
        ...
        <a href="https://www.linkedin.com/in/karinapeters/" target="_blank">
          <svg xmlns="http://www.w3.org/2000/svg" width={ICON_SIZE} height={ICON_SIZE} fill="currentColor" viewBox="0 0 16 16">
